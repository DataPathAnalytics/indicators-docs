#####################################################################################################################################################################################################################
RISK-2-6. Уникнення застосування конкурентних процедур закупівель робіт, що передбачені Законом.
#####################################################################################################################################################################################################################
...
2. Перевіряється валюта, в якій вказана очікувана вартість процедури відповідно до поля ``data.value.currency``
  ...
  2.в) В аналітичній таблиці шукаємо рядок, з ідентифікатором та CPV, що співпадають з нашими. Якщо рядок існує, додаємо суму з аналітичної таблиці до нашої очікуваної вартості. Якщо сума виходить більша або дорівнює 1500000 грн., то індикатор приймає значення ``1``.

  2.г) Якщо в аналітичній таблиці немає співпадіння, або сума менше за 1500000 грн., індикатор приймає значення ``0``.
